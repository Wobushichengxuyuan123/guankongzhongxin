(function (global, factory) {
	 ...
	 */
	// A50F01017D000033
	// A5.0F.01.01.7D.00.00.33
	// 所以对一个内存地址，也就是8位二进制，如：ob 0000 0001，0000就是高四位，0001就是低四位，
	// ob = output buffer 输出缓冲。缓冲区又称为缓存，它是内存空间的一部分。
	...
	const SPEED_ARRAY = [0x19, 0x32, 0x4b, 0x64, 0x7d, 0x96, 0xAF, 0xC8, 0xE1, 0xFA]; // 0x01 :   000000001
	// 0x02 :   000000010
	// 0x03 :   000000011
	// ……
	// 0x10 :000010000
	...
	const POSITION_ARRAY = [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A]; // 0H~FH; 低四位地址是，高四位0000
	...
	function ptzCmdToString() {
	  let indexValue3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0x00;
	  let indexValue4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0x00;
	  let indexValue5 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0x00;
	  let indexValue6 = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0x00;
	  //
	  let cmd = new ArrayBuffer(8); // 首字节以05H开头
	  ...
	  if (indexValue3 !== undefined) {
	    cmd[3] = indexValue3;
	  } // 数据1


	  if (indexValue4 !== undefined) {
	    cmd[4] = indexValue4;
	  } // 数据2


	  if (indexValue5 !== undefined) {
	    cmd[5] = indexValue5;
	  } // 组合码2，高4位是数据3，低4位是地址的高4位 - 变焦倍率


	  if (indexValue6 !== undefined) {
	    cmd[6] = indexValue6;
	  }
	...
	var _excluded$2 = ["type"],
	    ...
	    _excluded21 = ["type", "speed"],
	    _excluded22 = ["type", "speed"];
	...
	var getPTZPath = getPTZCmd;
	var TYPE = PTZ_TYPE;

	var noop$1 = function noop() {}; // http://192.168.1.70:8081/api/gb28181/control?id=34020000001420000123&channel=34020000001320000001&ptzcmd=A50F01017D000033
	...
	var PTZController = function PTZController() {
	  ...
	  _defineProperty(this, "__getPTZCmd", function (_ref2) {
	    ...
	    if (_this.origin) {
	      if (_this.port && _this.origin.indexOf('' + _this.port) < 0) {
	        return "".concat(_this.origin, ":").concat(_this.port, "/api/gb28181/control?id=").concat(id, "&channel=").concat(channel, "&ptzcmd=").concat(cmd);
	      }
	      if (!id) {
		  ...
		  var ptzUrl = "/webrtc-api/gb28181/control?id=".concat(id, "&channel=").concat(channel, "&ptzcmd=").concat(cmd);
	  ...
	  _defineProperty(this, "stop", function () {
	    var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	        _ref3.type;
	        var props = _objectWithoutProperties(_ref3, _excluded$2);

	    var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
	    return _this.__getPTZCmd(_objectSpread$2({
	      type: PTZ_TYPE.stop
	    }, props), callback);
	  });
	  ...
	  _defineProperty(this, "enlarge", function () {
	    var _ref23 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	        _ref23.type;
	        var speed = _ref23.speed,
	  ...
	  this.id = _id;
	  console.log('speed: => ', this.id, this.channel, this.index);
	};
	...
	var _excluded$1 = ["onStop", "onClick", "onMouseDown", "onMouseUp", "onTouchStart", "onTouchEnd", "parentClass"];
	...
	function Arrow() {
	  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
	      ...
	      onStop = _ref$onStop === void 0 ? noop : _ref$onStop,
	  ...
	  return /*#__PURE__*/React__default["default"].createElement("span", {
	    ...
	    onTouchEnd: onStop
	  }, /*#__PURE__*/React__default["default"].createElement("i", props));
	}
	function PtzControl28181(props) {
	  var _useState = React.useState(false),
	      _useState2 = _slicedToArray(_useState, 2),
	      ptz = _useState2[0],
	      setPtz = _useState2[1]; // 是否正在移动


	  var _useState3 = React.useState(4.0),
	      _useState4 = _slicedToArray(_useState3, 2),
	      speed = _useState4[0],
	      setSpeed = _useState4[1]; // 是否正在移动



	  React.useEffect(function () {
	    if (!ptz) {
	      var _ptz = new PTZController(props);
	  ...
	  var onStart = function onStart(ptzCmd) {
		
	    if (ptz) {
	      ptzCmd(_objectSpread$1(_objectSpread$1({}, props), {}, {
	        speed: speed
	      }), function (error, ptzUrl, cmd) {
	        if (error) {
	          return props.error && props.error(error);
	        }
	        if (props.resetPath && cmd) {
	          ptzUrl = props.resetPath(cmd) || ptzUrl;
	        }

	        fetch(ptzUrl).catch(console.error);
	      });
	    } else {
	      props.error && props.error('ptz not find!');
	    }
	  };

	  var onStop = function onStop() {
	    if (ptz) {
	      ptz.stop({}, function (error, stopUrl, cmd) {
	        if (error) {
	          return props.error && props.error(error);
	        }

	        if (props.resetPath && cmd) {
	          stopUrl = props.resetPath(cmd);
	        }

	        fetch(stopUrl).catch(console.error);
	      });
	    } else {
	      props.error && props.error('ptz not find!');
	    }
	  ...
	  return /*#__PURE__*/React__default["default"].createElement("div", {
	    ...
	    onClick: function onClick() {
	      return onStart(ptz.topLeft);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-up",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.top);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-up-right",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.topRight);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-left",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.left);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    ...
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.right);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-down-left",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.bottomLeft);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-down",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.bottom);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    className: "btn-down-right",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.bottomRight);
	    }
	  })), /*#__PURE__*/React__default["default"].createElement("div", {
	    ...
	    title: "\u8C03\u7126-",
	    parentClass: "zoom control-zoom-out",
	    className: "zoom-out",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.zoomNear);
	    }
	  }), /*#__PURE__*/React__default["default"].createElement(Arrow, {
	    title: "\u8C03\u7126+",
	    parentClass: "zoom control-zoom-in",
	    className: "zoom-in",
	    onStop: onStop,
	    onClick: function onClick() {
	      return onStart(ptz.zoomFar);
	    }
	  })));
	}
	...
	var PtzControl$1 = function PtzControl(serviceId, address, user, pass) {
	  var _this = this;
	  ...
	  this.ptzMoveRequest = function (x, y) {
	    var speed = {
	      x: x,
	      y: y,
	      z: 0
	  ...
	  this.left = function () {
	    return _this.ptzMoveRequest(-1, 0);
	  };

	  this.topLeft = function () {
	    return _this.ptzMoveRequest(-1, 1);
	  };

	  this.top = function () {
	    return _this.ptzMoveRequest(0, 1);
	  };
	...
	PTZControlRTSP.PtzControl = PtzControl$1;

	var _excluded = ["type", "origin", "id", "channel", "initPTZ", "serverIp", "address", "username", "password"];

	function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	function PtzControl(_ref) {
	  var _ref$type = _ref.type,
	      type = _ref$type === void 0 ? 'rtsp' : _ref$type,
	      origin = _ref.origin,
	      id = _ref.id,
	      channel = _ref.channel,
	      status = _ref.status,
	      _ref$initPTZ = _ref.initPTZ,
	      initPTZ = _ref$initPTZ === void 0 ? function (arg) {} : _ref$initPTZ,
	      serverIp = _ref.serverIp,
	      address = _ref.address,
	      username = _ref.username,
	      password = _ref.password,
	      otherProps = _objectWithoutProperties(_ref, _excluded);

	  var config28181 = _objectSpread({
	    id: id,
	    origin: origin,
	    channel: channel,
	    status: status,
	  ...
	  if (type === '28181') {
	    return /*#__PURE__*/React__default["default"].createElement(PtzControl28181, config28181);
	  } else {
	    return /*#__PURE__*/React__default["default"].createElement(PTZControlRTSP, configRTSP);
	  }
	}
	PtzControl.getPTZPath = getPTZPath;
	PtzControl.TYPE = TYPE;
	PtzControl.PtzControl = PTZControlRTSP.PtzControl;
