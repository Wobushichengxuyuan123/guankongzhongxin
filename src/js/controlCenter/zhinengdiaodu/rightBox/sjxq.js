...
// ~ --------------------------------------------------plug-in-------------------
import { Tabs, Input, Collapse, Spin, Icon, Button } from "antd";
...
class Sjxq extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      sjxqList: [
        ...
        { title: '发生区域: ', prop: 'happenArea', content: "" },
  ...
  getSjxqList = () => {
    ...
    fetch('/zhdd-zhdd/yjzhYjzhBattleSuddenEventInf/getSuddenEventInfById', {
      method: 'POST',
