...
import {Input, Collapse, Spin, message} from 'antd/lib/index';
...
class Main extends React.Component {
  ...
  render() {
    ...
    return (<div className="entranceGuard">
      <div className="title">洞室技经</div>
      <div>
        <div className="searchDiv" style={{paddingTop: 20}}>
          <Search className="entranceGuardSearchInput searchInput" placeholder="请输入技经名称"
